	...
	<div class="nav-scroller mb-2">
		...
		<div class="nav-scroller mb-2">
			...
			<a href="iphone11.php" class="p-2 text-white">Iphone 11</a>
				<a href="iphoneXR.php" class="p-2 text-white">Iphone Xr</a>
				<a href="iphone8.php" class="p-2 text-white">Iphone 8</a>
				<a href="iphone7.php" class="p-2 text-white">Iphone 7</a>
			</nav>
		</div>

	<div class="jumbotron" id="iphonexr" name=iphonexr">
		<div class="container">
			<div class="row">
				<div class="col">
					<a href="#" class="blog-logo text-black">
						
					</a>
					<a class="blog-logo text-black">
						<br>
						Video 4K
		Dirección. Edición. Iluminación. A ganar premios en todas las categorías.
