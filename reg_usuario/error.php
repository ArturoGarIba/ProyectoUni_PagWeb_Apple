...
<html>
    ...
    <body class="body" onLoad="alert('Ingresa las contraseñas igual');" onUnLoad="confirm('OK!);">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                                     ...
                                                     <input type="password"  id="con" name="con" class="form-control" placeholder="Contraseña" required>
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">
                                                     ...
                                                     <input type="password" id="con2" name="con2" class="form-control" placeholder="Confirmar contraseña" required>
